...
import com.example.training_shivam.adapter.MyAdapter
...
//        progressBar =rootView.findViewById(R.id.MyprogressBar)
        ...
        var contactListViewModel : ContactListViewModel = ViewModelProviders.of(this).get(ContactListViewModel::class.java)
        contactListViewModel.getArrayList().observe(this, Observer {contactListViewModels->
            MyAdapter = MyAdapter(activity as AppCompatActivity, contactListViewModels!!)
