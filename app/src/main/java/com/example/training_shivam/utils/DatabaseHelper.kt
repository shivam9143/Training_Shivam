...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    private val CREATE_USER_TABLE = ("CREATE TABLE " + TABLE_USER + "("
            ...
            + COLUMN_USER_EMAIL + " TEXT," +  COLUMN_USER_MOBILE + " TEXT,"
            + COLUMN_USER_ADDRESS + " TEXT," + COLUMN_PIC_FILENAME + " TEXT," +  COLUMN_USER_PASSWORD + " TEXT" + ")")
    ...
    fun getLoggedInUserDetails( email :String) : User
    {
        var result: User
        val db = this.readableDatabase
        val selectQuery = "SELECT  * FROM $TABLE_USER WHERE $COLUMN_USER_EMAIL = ?"
        db.rawQuery(selectQuery, arrayOf(email)).use { // .use requires API 16
            if (it.moveToFirst()) {
                var id = it.getInt(it.getColumnIndex(COLUMN_USER_ID))
    ...
    fun getAllUser(): List<User> {
        ...
        val columns = arrayOf(COLUMN_USER_ID, COLUMN_USER_EMAIL, COLUMN_USER_NAME, COLUMN_USER_MOBILE, COLUMN_USER_ADDRESS, COLUMN_PIC_FILENAME, COLUMN_USER_PASSWORD)
        ...
        if (cursor.moveToFirst()) {
            do {
                val user = User(id = cursor.getString(cursor.getColumnIndex(COLUMN_USER_ID)).toInt(),
                        ...
                        mobile =   cursor.getString(cursor.getColumnIndex(COLUMN_USER_MOBILE)),
                        address =   cursor.getString(cursor.getColumnIndex(COLUMN_USER_ADDRESS)),
                        pic =   cursor.getString(cursor.getColumnIndex(COLUMN_PIC_FILENAME)))
    ...
    fun checkUser(email: String): Boolean {
        ...
        //Log.e("All Users", getAllUser().toString()+";")
    ...
    companion object {
        ...
        private val COLUMN_PIC_FILENAME = "user_pic"
